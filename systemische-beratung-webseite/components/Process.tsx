...
import ProcessStepIcon from './icons/ProcessStepIcon';

const Process: React.FC = () => {
  const steps = [
    { title: 'Muster erkennen', description: 'Wir schauen genau hin, welche wiederkehrenden Muster Ihre Situation prägen.' },
    { title: 'Ressourcen heben', description: 'Wir entdecken und aktivieren Ihre verborgenen Stärken und Fähigkeiten.' },
    { title: 'Lösungen kreieren', description: 'Gemeinsam entwickeln wir passende, umsetzbare und nachhaltige nächste Schritte.' },
    { title: 'Freiheit leben', description: 'Sie gewinnen neue Handlungsspielräume und gestalten Ihre Zukunft selbstbestimmt.' },
  ];
