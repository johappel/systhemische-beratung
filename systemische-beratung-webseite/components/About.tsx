...
const Card: React.FC<{ imgSrc: string; title: string; quote: string; }> = ({ imgSrc, title, quote }) => (
    <div className="bg-hellgruen rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
        <img src={imgSrc} alt={title} className="w-full h-48 object-cover" />
        <div className="p-6">
            <h3 className="font-heading text-xl font-bold text-orange mb-2">{title}</h3>
...
const About: React.FC = () => {
  return (
    <section id="ueber-mich" className="py-20 bg-helllila">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="mt-12 text-sm text-dunkelgruen/80">
